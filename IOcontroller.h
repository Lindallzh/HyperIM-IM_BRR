...
public:
    ...
    static void WriteResult(const std::string& outFileName, const TResult& resultObj, const std::string& outFolder)
    {
        ...
        std::cout << "   --------------------" << std::endl;
        std::cout << "  |ApproxCNT.: " << approx << std::endl;
        std::cout << "  |Time (sec)CNT: " << runTime << std::endl;
        std::cout << "  |InfluenceCNT: " << influence << std::endl;
        std::cout << "  |Self-estimated influenceCNT: " << influenceOriginal << std::endl;
        std::cout << "  |#Seeds: " << seedSize << std::endl;
        std::cout << "  |#RR setsCNT: " << RRsetsSize << std::endl;
        std::cout << "   --------------------" << std::endl;
